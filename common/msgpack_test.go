...
func TestMsgpack(t *testing.T) {
	...
	tx.AddScriptOutput([]Address{receiver.Address()}, NewThresholdScript(1), NewIntegerFromString(amount))
	tx.AddScriptOutput([]Address{sender.Address()}, NewThresholdScript(1), charge)
