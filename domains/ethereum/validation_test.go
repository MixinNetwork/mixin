...
func TestValidation(t *testing.T) {
	...
	require.Equal(crypto.NewHash([]byte("c94ac88f-4671-3976-b60a-09064f1811e8")), GenerateAssetId(xin))
	require.Equal(crypto.NewHash([]byte("4d8c508b-91c5-375b-92b0-ee702ed2dac5")), GenerateAssetId(usdt))
	require.Equal(crypto.NewHash([]byte("43d61dcd-e413-450d-80b8-101d5e903357")), GenerateAssetId("0x0000000000000000000000000000000000000000"))
	require.Equal(crypto.NewHash([]byte("43d61dcd-e413-450d-80b8-101d5e903357")), EthereumChainId)
}
