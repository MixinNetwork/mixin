...
func TestValidation(t *testing.T) {
	...
	require.Equal(crypto.NewHash([]byte("2204c1ee-0ea2-4add-bb9a-b3719cfff93a")), GenerateAssetId("0x0000000000000000000000000000000000000000"))
	require.Equal(crypto.NewHash([]byte("2204c1ee-0ea2-4add-bb9a-b3719cfff93a")), EthereumClassicChainId)
}
