...
func TestValidation(t *testing.T) {
	...
	assert.Equal(crypto.NewHash([]byte("d0688ff7-6656-4a79-bd5f-d764bfa9bc46")), GenerateAssetId("0x0000000000000000000000000000000000000000"))
	assert.Equal(crypto.NewHash([]byte("d0688ff7-6656-4a79-bd5f-d764bfa9bc46")), ArbitrumChainId)
}
